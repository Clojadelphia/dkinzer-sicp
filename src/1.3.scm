    ...
    (if (= 0 b)
     ((lambda ()
      ...
      (if (= 0 (abs-modulo y (car a)))
        ((lambda ()
           (display (string "First option: \n"))
           (display (string "abs-modulo of " y " and " (car a) " is "(abs-modulo y (car a)) " \n"))
           (display (string "car a "(car a) "\n"))
           (display "A: ")
           (display a)
           (display "\n")
           (display "\n")
           (iter (cdr a) (dec b) (cons (car a) result))
           ))
        ((lambda ()
           (display (string "Second option: \n"))
           (display (string "abs-modulo of " y " and " (car a) " is "(abs-modulo y (car a)) " \n"))
           (display (string "car a "(car a) "\n"))
           (display "A: ")
           (display a)
           (display "\n")
           (display "\n")
           (iter (cdr a) (dec b) result)
           ))
        )))
  (let ((x-factors (factors x)))
    (iter x-factors (length x-factors) (list))))
